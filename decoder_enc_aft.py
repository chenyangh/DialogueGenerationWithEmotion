...
class BeamSearchDecoder(object):
    ...
    def translate(self, _emo):
        ...
        df.to_csv('outputs/simple_beam' + str(self.beam_size) + '_bar_' + str(_emo) + '.csv', encoding='utf-8', index=False)
...
def main(beam_size):
    ...
    model.cuda()
    model_path = 'checkpoint/new_simple_bar_epoch_22.model'
    ...
    for __emo in range(9):
        test_set = EmotionDataLoaderBar(X, y, __emo, pad_len, word2id)
