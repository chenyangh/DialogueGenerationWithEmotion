...
class BeamSearchDecoder(object):
    ...
    def translate(self, _emo):
        ...
        for i, (src, trg, _) in tqdm(enumerate(self.data_loader),
            ...
            hypotheses, scores = decoder.decode_batch(Variable(src, volatile=True).cuda(), _emo)
        ...
        df.to_csv('outputs/persona_beam' + str(_emo) + '.csv', encoding='utf-8', index=False)
...
if __name__ == '__main__':
    ...
    test_set = EmotionDataLoader('OpenSubData/data_6_test.csv', 'OpenSubData/data_6_test.tag',
                                 pad_len, word2id, max_size=10000)
    test_loader = DataLoader(test_set, batch_size=batch_size)

    model_path = 'checkpoint/new_persona_epoch_6.model'
    ...
    for __emo in range(9):
        decoder = BeamSearchDecoder(model, test_loader, pad_len, 3, word2id, id2word)
