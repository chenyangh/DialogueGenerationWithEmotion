...
from utils.beam_search_with_start_token import Beam
import pandas as pd
import numpy as np
...
class BeamSearchDecoder(object):
    ...
    def decode_batch(self, input_lines_src, _emo):
        ...
        emo_token = '<' + str(_emo) + '>'
        beam = [
            Beam(beam_size, self.tgt_dict, emo_token, cuda=True)
    ...
    def translate(self, _emo):
        ...
        df.to_csv('outputs/simple_start_beam_' + str(self.beam_size) + '_bar_' + str(_emo) + '.csv', encoding='utf-8', index=False)
